...
void statboostingmove::boost_stats_player(playable* pptr){
    int new_damage_factor = pptr->get_damage_factor() + additional_damage_factor;
    int new_healing_factor = pptr->get_healing_factor() + additional_healing_factor;
...
void statboostingmove::boost_stats_chad(Gigachad* gigaptr){
    int new_damage_factor = gigaptr->get_damage_factor() + additional_damage_factor;
    int new_healing_factor = gigaptr->get_healing_factor() + additional_healing_factor;
